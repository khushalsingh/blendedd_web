						...
						<div class="tab-pane active" id="messages">
							<div class="row">
								<div class="col-lg-3 col-md-3">
									...
									<div class="row">
										<div class="col-lg-8 col-md-8"><h2><a class="active" href="<?php echo base_url(); ?>messages/sent">Sent</a></h2></div>
									</div>
									<div class="row">
...
<script type="text/javascript">
	...
	$('#messages_datatable').dataTable({
		"aaSorting": [['0', 'desc']],
		"sAjaxSource": base_url + "messages/sent_datatable",
		"aoColumnDefs": [
			{
				"aTargets": [0],
				"bSortable": false,
	...
	function delete_messages() {
		...
		if (posts_ids_array.length > 0) {
			bootbox.confirm('Do You want to move selected messages to trash ?', function (result) {
				if (result) {
					$.post(base_url + 'messages/mark_sent_messages_deleted_by_post_id', {'posts_id[]': posts_ids_array}, function (data) {
						if (data === '1') {
