                                ...
                                <div class="col-lg-9 col-md-9">
                                    ...
                                    <form role="form" method="post" action="" id="user_edit_form">
                                        <div id="user_edit_form_div">
                                            <?php if (isset($_SESSION['user']['user_dob']) && $_SESSION['user']['user_dob'] === '0000-00-00') { ?>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 business_div" style="display: none;">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="business_tax_id" name="business_tax_id" placeholder="Business Tax ID">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
