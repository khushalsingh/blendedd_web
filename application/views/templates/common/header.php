...
<html>
    <head>
        <meta charset="UTF-8" />
        <title><?php echo isset($title) ? $title : ucwords(str_replace('_', ' ', $this->router->class)) . (($this->router->method === 'index') ? '' : ' ' . ucwords(str_replace('_', ' ', $this->router->method))); ?> | Blendedd</title>
