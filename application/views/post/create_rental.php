    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="well well-lg background_white">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form id="post_item_form" name="post_item_form" method="post" action="<?php echo base_url(); ?>post/preview" target="post_preview_window">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div id="rootwizard">
                                        <ul>
                                            <li><a class="" href="#item" data-toggle="tab"><span class="glyphicon glyphicon-play-circle"></span> Item</a></li>
                                            <li><a class="" href="#rate" data-toggle="tab"><span class="glyphicon glyphicon-play-circle"></span> Rate</a></li>
                                            <li><a class="" href="#availability" data-toggle="tab"><span class="glyphicon glyphicon-play-circle"></span> Availability</a></li>
                                            <li><a class="" href="#upload_image" data-toggle="tab"><span class="glyphicon glyphicon-play-circle"></span> Images</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane" id="item"><br/>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
														<div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="checkbox-inline"><input type="checkbox" id="post_show_on_map" name="post_show_on_map" class="" value="1" <?php
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="post_street" id="post_street" class="form-control" placeholder="Enter Street" value="<?php
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="input_cross_street">Cross Street</label>
                                                                    <input type="text" name="post_cross_street" id="post_cross_street" class="form-control" placeholder="Enter Cross Street" value="<?php
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="input_state">State / Province <span class="required">*</span></label>
                                                                    <select class="form-control" id="states_id" name="states_id" data-placeholder="State / Province">
                                                                        <option></option>
																		<?php
																		if (isset($states_array) && $post_details_array['states_id']) {
																			foreach ($states_array as $state) {
																				?>
																				<option value="<?php echo $state['state_id']; ?>" <?php
																				if ($state['state_id'] == $post_details_array['states_id']) {
																					echo ' selected="selected"';
																				}
															...
															<div>
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" name="post_zipcode" id="post_zipcode" class="form-control" maxlength="5" placeholder="Enter Zip Code" value="<?php
                                            ...
                                            <div class="tab-pane" id="rate"><br/>
                                                <div class="row" >
                                                    <div class="col-md-5 col-lg-5">
														<?php foreach ($item_price_array as $item_price) { ?>
															<div class="row">
																...
																<div class="col-md-6 form-group">
																	<input type="text" class="form-control post_price" id="<?php echo 'post_' . $item_price['pricing_option_type'] . '_price'; ?>" name="<?php echo 'post_' . $item_price['pricing_option_type'] . '_price'; ?>" value="<?php
																	if (isset($post_details_array['post_' . $item_price['pricing_option_type'] . '_price'])) {
																		if ($post_details_array['post_' . $item_price['pricing_option_type'] . '_price'] != '0') {
																			echo $post_details_array['post_' . $item_price['pricing_option_type'] . '_price'];
																		}
																	}
																	?>">
																</div>
                                                        ...
                                                        <div class="row" >
                                                            <div class="col-md-12">
                                                                <p>Please price items competitively. You do not need to fill out all the price tabs, but one price tab filled out is required.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="availability"><br/>
                                                <div class="row">
													<div class="col-md-8">
                                            ...
                                            <div class="tab-pane" id="upload_image"><br/>
                                                <div class="row" >
                                                    <div class="col-md-12 col-lg-12">
                                                        <div>&nbsp;</div>
														<div class="row">
...
<script type="text/javascript">
																		$(function () {
																			...
																			$("#select_all_days").click(function () {
																				if ($(this).is(':checked')) {
																					$('.post_availability').each(function (i, v) {
																						if ($("#post_availability_" + $(v).val() + ":checked").length == 0) {
																							$("#post_availability_count").val(parseInt($("#post_availability_count").val()) + 1);
																						}
																						$(v).prop('checked', true);
																			...
																			var $validator = $("#post_item_form").validate({
																				errorElement: 'span',
...
//																					},
																			...
																			$('select').change(function () {
																				$("#post_item_form").validate().element($(this));
																			});
																			...
																			$("#pager_finish").click(function () {
																				...
																				   $("#post_item_form").submit();
																			});
																			$("#pager_publish").click(function () {
																				$.post('', $("#post_item_form").serialize(), function (data) {
																					if (parseInt(data) > 0) {
																		...
																		function handle_wizard(tab, navigation, index, $validator) {
																			...
																			var $valid = $("#post_item_form").valid();
																			if (!$valid) {
